...
*   **Elo Rating Model (v1.0.0)**: **Completato e Stabile**. Traccia i rating di forza relativa dei team in ordine cronologico. Integrato nel motore di backtesting in modo dinamico e immune da data leakage. In modalità di calcolo manuale (stateless) opera in modalità controllata predefinita (1500 Elo).
