  ...
  const models = [
    {
      ...
      description: 'Stima i gol attesi indipendenti basandosi sulle medie storiche di attacco e difesa.',
      status: 'attivo',
    ...
    {
      id: 'poisson_gamma',
      name: 'Poisson-Gamma (Bivariato)',
      description: 'Introduce una distribuzione Gamma come a-priori coniugato per modellare la sovradispersione e la correlazione intrinseca tra i gol segnati dalle due squadre.',
      status: 'in_arrivo',
      type: 'Bayesiano',
      complexity: 'Alta',
      strength: 'Gestisce meglio le partite ad alto punteggio e la variabilità strutturale dei team.',
      icon: Code,
      color: 'border-slate-700/50 bg-slate-900/50 text-slate-400',
    },
    {
