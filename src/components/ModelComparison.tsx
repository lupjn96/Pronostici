...
export default function ModelComparison() {
  const models = [
    ...
    },
    {
      ...
      status: 'attivo',
      type: 'Modello statistico correttivo',
      complexity: 'Media',
      strength: 'Risolve la sottostima dei pareggi e degli incontri con pochi gol attraverso il parametro di dipendenza rho.',
      icon: Layers,
      color: 'border-emerald-500/30 bg-emerald-500/10 text-emerald-400',
    },
    {
